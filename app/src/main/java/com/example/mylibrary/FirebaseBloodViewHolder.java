...
public class FirebaseBloodViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    View mView;
    Context mContext;

    public FirebaseBloodViewHolder(View itemView) {
        super(itemView);
        mView = itemView;
    ...
    public void onClick(View view) {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference(Constants.FIREBASE_CHILD_CENTERS);
